  ...
  <v-container class="text-xs-center">
      ...
      <v-layout row
        ...
        <v-flex xs12
          ...
          <v-card class="mt-3 ml-1 mr-2"
            ...
            <v-btn @click="handleDeleteUserPost(post)"
                   color="error"
                   floating
                   fab
                   small
    ...
    <v-dialog xs12
      ...
      <v-card>
        ...
        <v-container>
          <v-form @submit.prevent="handleUpdateUserPost"
                  ref="form"
                  v-model="isFormValid"
                  lazy-validation>
            ...
            <v-card-actions>
              ...
              <v-btn class="error--text"
                     flat
                     @click="editPostDialog = false">Cancel</v-btn>
            </v-card-actions>
